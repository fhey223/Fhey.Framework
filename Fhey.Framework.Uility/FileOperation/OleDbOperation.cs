...
namespace Fhey.Framework.Uility.FileOperation
{
    ...
    public class OleDbOperation 
    {
        ...
        /// 连接字符串模板
        /// </summary>
        private const string ConnectionStringTemplate = "Provider=Microsoft.ACE.OLEDB.{0};Data Source={1};Extended Properties=\"Excel {0} Xml;HDR=YES;IMEX=1;\";";
        #endregion
        ...
        {
            return new OleDbConnection(GetConnectionString(excelPath));
        }
        ...
        /// <returns></returns>
        private static string GetConnectionString(string excelPath)
        {
            return string.Format(CultureInfo.InvariantCulture, ConnectionStringTemplate, ExcelDefaultVersion, excelPath);
        }
