...
namespace Fhey.Framework.Uility.FileOperation
{
    public class NpoiOperation
    {
        ...
        /// <param name="fileName">文件名(全名)</param>
        /// <param name="isColumnWritten">DataTable的列名是否要导入</param>
        /// <param name="Mode">导出模式：直接导出：0，浏览器下载：1</param>
        /// <param name="sheetName">要导入的excel的sheet的名称</param>
        /// <returns>导入数据行数(包含列名那一行)</returns>
        public int DataTableToExcel(DataTable data, string fileName, string sheetName, bool isColumnWritten, int mode = 0)
        {
            int i = 0;
            int j = 0;
            int count = 0;
            ...
            try
            {
                ...
                for (i = 0; i < data.Rows.Count; ++i)
                {
                    ...
                    //{
                    //    ICell currentCell = row.GetCell(i);
                    //    if (currentCell != null)
                    //    {
        ...
        /// </summary>
        ///  <param name="文件名">excel工作薄sheet的名称</param>
